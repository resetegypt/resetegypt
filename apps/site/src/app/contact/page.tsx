...
const HOURS = [
  ...
  { day: 'Vendredi', time: '11h00 – 22h00' },
  { day: 'Samedi – Dimanche', time: '11h00 – 22h00' },
];
    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 lg:pt-24 pb-8 text-center">
          ...
          <p className="mt-6 text-base sm:text-lg text-text-secondary leading-relaxed max-w-2xl mx-auto">
            WhatsApp, téléphone, ou visite directe au centre — choisissez le canal qui vous
            convient.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-20 bg-bg-secondary/40">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="rounded-2xl bg-surface border border-border-light p-7 lg:p-8">
            ...
            <a
              href="https://maps.google.com/?q=N+Teseen+New+Cairo+1+Le+Caire"
              target="_blank"
              rel="noreferrer"
          ...
          <div className="rounded-2xl bg-surface border border-border-light p-7 lg:p-8">
            ...
            <div className="mt-6 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary-lightest text-primary text-xs font-semibold">
              ...
              Réservation flexible 24/7 en ligne
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-28 text-center px-4 bg-primary text-white">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="mt-4 text-base text-primary-light leading-relaxed">
            En moins de 2 minutes. Choisissez votre service, votre créneau, c'est tout.
          </p>
          <Link
...
function ContactCard({
  ...
  return (
    ...
    >
      ...
      <div className={`text-[10px] font-bold tracking-[0.28em] uppercase mb-1.5 ${primary ? 'text-white/70' : 'text-primary'}`}>
        {title}
      </div>
      <div className={`text-base font-bold tabular-nums ${primary ? 'text-white' : 'text-text'}`}>
        {value}
      </div>
      <div className={`mt-4 inline-flex items-center gap-1 text-sm font-semibold group-hover:gap-2 transition-all ${primary ? 'text-white' : 'text-primary'}`}>
        {cta}
        <ArrowRight className="w-3.5 h-3.5" />
      </div>
    </a>
